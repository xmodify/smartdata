...
CREATE TABLE `sys_var`  (
  `sys_name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sys_name_th` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL,
  `sys_value` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
  `created_at` timestamp(0) NULL DEFAULT NULL,
  `updated_at` timestamp(0) NULL DEFAULT NULL,
  PRIMARY KEY (`sys_name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Compact;
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, 'นายศิริฤกษ์ คณาดี', 'modifya@gmail.com', '2026-02-08 23:16:33', '$2y$12$J9QXDbwBbfmUq0i.yw3JMOTdPTD6HplM.3K4wnRsmFzmhDu.M5rte', '1341800003078', 'admin', 'Y', 'P8kx7B7TKTjinaESQM9qri7lAnJ3627If4OT1hN2kFg5Q24yBnaCnVlj50Xv', '2026-02-08 23:16:34', '2026-02-08 23:16:34');

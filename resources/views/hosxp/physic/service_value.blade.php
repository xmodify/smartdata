...
@push('styles')
    ...
    <style>
        ...
        .nav-tabs-custom .nav-link:hover { color: #f97316; background: #fff7ed; }
    ...
    <div class="container-fluid px-2 px-md-3">
            ...
            <div class="d-flex align-items-center">
                <div class="ps-3 py-1">
                    <h5 class="text-dark mb-0 fw-bold">
                        <i class="fas fa-hand-holding-usd text-orange me-2"></i>
                        {{ $title }}
                    </h5>
            ...
            <div class="d-flex align-items-center">
                <form action="" method="GET" class="m-0 header-form-controls">
                    <div class="input-group input-group-sm shadow-sm input-group-date">
                        <span class="input-group-text bg-white border-end-0 text-orange"><i class="fas fa-calendar-alt"></i></span>
                    ...
                    <div class="input-group input-group-sm shadow-sm input-group-budget">
                        ...
                        <button type="submit" class="btn btn-orange text-white px-3"><i class="fas fa-search"></i></button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs border-0" id="valueTabs" role="tablist">
                <li class="nav-item">
                    <button class="nav-link active" id="pt-tab" data-bs-toggle="tab" data-bs-target="#pt" type="button" role="tab">
                        <i class="fas fa-walking me-1"></i> รายการกายภาพบำบัด
                    </button>
                </li>
                <li class="nav-item">
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                ...
                // Adjust charts on tab change
                $('button[data-bs-toggle="tab"]').on('shown.bs.tab', function (e) {
                    $.fn.dataTable.tables({ visible: true, api: true }).columns.adjust();
                });

                // Date Picker and Budget Year Sync (Thai Year Support)

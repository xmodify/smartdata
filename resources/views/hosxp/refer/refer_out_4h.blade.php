...
@section('content')
    <div class="container-fluid px-2 px-md-4">
            ...
            <div class="d-flex align-items-center">
                <form action="" method="GET" class="m-0">
                    <div class="input-group input-group-sm shadow-sm" style="width: 230px; border-radius: 8px; overflow: hidden;">
                        <span class="input-group-text bg-light text-primary border-end-0 fw-bold" style="font-size: 0.8rem;">เลือก</span>
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-4">
                <div class="card stat-card text-white h-100 shadow-sm" style="background: var(--primary-gradient);">
                    <div class="card-body">
        ...
        <div class="card border-0 shadow-sm mb-4" style="border-radius: 15px;">
                ...
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                    <div>
                        <h6 class="m-0 fw-bold text-primary">
                            <i class="fas fa-user-injured me-1"></i> รายชื่อผู้ป่วยส่งต่อ Refer Out (ภายใน {{ $hours }} ชม.)
                        </h6>
            ...
            <div class="card-body p-4" id="tableContainer">
                @include('hosxp.refer.partials._table_refer_out')
            </div>
        </div>
    </div>
    ...
    @push('scripts')
        ...
        <script>
            ...
            function loadTableData(startDate, endDate) {
                ...
                $.ajax({
                    url: "{{ route('hosxp.refer.refer_out_' . $hours . 'h') }}",
                    method: 'GET',
                    data: {

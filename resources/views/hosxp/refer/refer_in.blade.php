...
@section('topbar_actions')
    <a href="{{ route('hosxp.stats.index') }}" class="btn btn-light btn-sm fw-bold shadow-sm"
        style="border-radius: 10px; padding: 5px 15px; color: #198754; transition: all 0.3s;">
    ...
    <div class="container-fluid px-2 px-md-3">
        ...
        <div class="page-header-container d-flex justify-content-between align-items-center mt-3">
            <div class="d-flex align-items-center report-title-box">
                <div class="ps-3 py-1">
                    ...
                    <div class="text-muted small mt-1">สรุปผลการดำเนินงานและสถิติการรับเข้า ปีงบประมาณ
        ...
        <div class="row g-3 mb-4">
                ...
                <div class="row g-3">
                    <div class="col-12">
                        <div class="card border-0 shadow-sm text-white"
                            style="border-radius: 12px; background: linear-gradient(135deg, #198754 0%, #157347 100%);">
                            <div class="card-body p-3">
                                <div class="small opacity-75">รวมรับเข้าทั้งหมด</div>
                    ...
                    <div class="col-12">
                        <div class="card border-0 shadow-sm text-white"
                            style="border-radius: 12px; background: linear-gradient(135deg, #0dcaf0 0%, #0bacce 100%);">
                            <div class="card-body p-3">
                                <div class="small opacity-75">OPD Refer In</div>
                    ...
                    <div class="col-12">
                        <div class="card border-0 shadow-sm text-white"
                            style="border-radius: 12px; background: linear-gradient(135deg, #ffc107 0%, #d39e00 100%);">
                            <div class="card-body p-3">
                                <div class="small opacity-75">IPD Refer In</div>
            ...
            <div class="col-xl-5">
                <div class="card border-0 shadow-sm h-100" style="border-radius: 12px;">
                    <div class="card-header bg-transparent border-0 pt-3 pb-0">
                        <h6 class="m-0 fw-bold text-success">แนวโน้มรายเดือน (ตามตัวเลือก)</h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-xl-4">
                <div class="card border-0 shadow-sm h-100" style="border-radius: 12px;">
                    <div class="card-header bg-transparent border-0 pt-3 pb-0">
                        <h6 class="m-0 fw-bold text-success">แนวโน้ม 5 ปี ย้อนหลัง</h6>
                    </div>
                    <div class="card-body">
                        <div class="chart-container">
                            ...
                            <table id="opdTable" class="table table-hover align-middle" style="width:100%">
                                ...
                                <tbody>
                                    @foreach ($refer_list_opd as $row)
                                        <tr>
                                            <td><span
                                                    class="badge bg-light text-success border px-2">{{ $row->hn }}</span>
                                            </td>
                                            <td>
                                                <div class="fw-bold">{{ $row->ptname }}</div>
                                            </td>
                                            <td><span
                                                    class="badge bg-info bg-opacity-10 text-info">{{ $row->pdx_refer }}</span>
                                            </td>
                                            <td><span
                                                    class="badge bg-success bg-opacity-10 text-success">{{ $row->pdx }}</span>
                                            </td>
                                            <td>{{ $row->refer_hos }}</td>

    ...
    <div class="container-fluid px-2 px-md-3">
        <div class="page-header-container d-flex justify-content-between align-items-center mt-3">
            <div class="d-flex align-items-center report-title-box">
                <div class="ps-3 py-1">
                    <h5 class="text-dark mb-0 fw-bold"><i class="fas fa-leaf text-success me-2"></i> {{ $title }}
                    </h5>
            ...
            <div class="d-flex align-items-center">
                <form action="" method="GET" class="m-0 header-form-controls">
                    ...
                    <div class="input-group input-group-sm shadow-sm input-group-budget"
                        ...
                        <button type="submit" class="btn btn-success px-3" style="font-size: 0.8rem;"><i
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm" style="border-radius: 15px;">
                    <div class="card-body p-5 text-center">
                        ...
                        <p class="text-muted">ระบบรายงานงานแพทย์แผนไทย

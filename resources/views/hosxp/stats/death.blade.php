                    ...
                    <tbody>
                        @foreach ($death_list as $row)
                            <tr>
                                ...
                                <td><div class="small text-dark">{{ DateThai($row->death_date) }}</div></td>
                                <td><div class="fw-bold">{{ $row->death_time }}</div></td>
                                <td><span class="badge bg-warning bg-opacity-10 text-warning text-dark" style="white-space: normal; text-align: left;">{{ $row->name504 }}</span></td>
                                <td><span class="badge bg-danger bg-opacity-10 text-danger text-dark" style="white-space: normal; text-align: left;">{{ $row->icdname }}</span></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>

        ...
        <div class="col-md-4 mb-3">
            <div class="card border-0 shadow-sm h-100" style="border-radius: 12px;">
                <div class="card-body p-3">
                    ...
                    <div class="list-group list-group-flush mt-2">
                        <a href="{{ route('hosxp.opd.index') }}" class="list-group-item list-group-item-action border-0 px-0 py-2 d-flex justify-content-between align-items-center">
        ...
        <div class="col-md-4 mb-3">
            <div class="card border-0 shadow-sm h-100" style="border-radius: 12px;">
                <div class="card-body p-3">
                    ...
                    <div class="list-group list-group-flush mt-2">
                        <a href="{{ route('hosxp.ipd.index') }}" class="list-group-item list-group-item-action border-0 px-0 py-2 d-flex justify-content-between align-items-center">
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius: 12px;">
                <div class="card-body p-3">
                    ...
                    <div class="list-group list-group-flush mt-2">
                        ...
                        <a href="{{ route('hosxp.er.ems') }}" class="list-group-item list-group-item-action border-0 px-0 py-2 d-flex justify-content-between align-items-center">
                            <span class="small">รายงานผู้ป่วยให้บริการ EMS</span>
                            <i class="fas fa-chevron-right smaller text-muted" style="font-size: 0.7rem;"></i>
                        </a>
                        <a href="{{ route('hosxp.er.wait_admit_2h') }}" class="list-group-item list-group-item-action border-0 px-0 py-2 d-flex justify-content-between align-items-center">
                            <span class="small">รายงานผู้ป่วยรอ Admit ที่ ER เกิน 2 ชั่วโมง</span>
                            <i class="fas fa-chevron-right smaller text-muted" style="font-size: 0.7rem;"></i>
                        </a>
                        <a href="{{ route('hosxp.er.revisit_48h') }}" class="list-group-item list-group-item-action border-0 px-0 py-2 d-flex justify-content-between align-items-center">
                            <span class="small">รายงาน Re-Visit ใน 48 ชม. ด้วยโรคเดิม</span>
                            <i class="fas fa-chevron-right smaller text-muted" style="font-size: 0.7rem;"></i>
                        </a>
                        <a href="{{ route('hosxp.er.top20') }}" class="list-group-item list-group-item-action border-0 px-0 py-2 d-flex justify-content-between align-items-center">
            ...
            <div class="card border-0 shadow-sm h-100" style="border-radius: 12px;">
                <div class="card-body p-3">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <h6 class="fw-bold mb-0">งานห้องปฏิบัติการ (Lab)</h6>
                    </div>
                    <div class="list-group list-group-flush mt-2">
                        <a href="{{ route('hosxp.lab.thyroid') }}" class="list-group-item list-group-item-action border-0 px-0 py-2 d-flex justify-content-between align-items-center">
                            <span class="small">รายงานการส่งตรวจแล็บไทรอยด์</span>
                            <i class="fas fa-chevron-right smaller text-muted" style="font-size: 0.7rem;"></i>
                        </a>
                    </div>
                </div>

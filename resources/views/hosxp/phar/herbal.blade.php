...
@section('content')
    <div class="container-fluid px-2 px-md-3">
        ...
        <ul class="nav nav-tabs nav-tabs-custom" id="herbalReportTabs" role="tablist">
        ...
        <div class="tab-content" id="herbalReportTabsContent">
            <!-- OPD Tab -->
                    ...
                    <div class="col-12">
                        <div class="card card-custom">
                            <div class="card-header bg-transparent border-0 pt-4 px-4">
                                <h6 class="fw-bold mb-0 text-green"><i class="fas fa-chart-line me-2"></i>ปริมาณการใช้ยาสมุนไพร (Qty) รายเดือน แยกตามตัวยา (OPD) <span class="text-muted small fw-normal">(แสดงข้อมูล Top 10)</span></h6>
                            </div>
                            <div class="card-body px-4 pb-4">
                                @if(count($chart_series_opd) > 0)
                                    <div id="herbalOpdChart" style="min-height: 300px;"></div>
                                @else
            ...
            <div class="tab-pane fade" id="ipd-content" role="tabpanel">
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-12">
                        <div class="card card-custom">
                            <div class="card-header bg-transparent border-0 pt-4 px-4">
                                <h6 class="fw-bold mb-0 text-red"><i class="fas fa-chart-line me-2"></i>ปริมาณการใช้ยาสมุนไพร (Qty) รายเดือน แยกตามตัวยา (IPD) <span class="text-muted small fw-normal">(แสดงข้อมูล Top 10)</span></h6>
                            </div>
                            <div class="card-body px-4 pb-4">
                                @if(count($chart_series_ipd) > 0)
                                    <div id="herbalIpdChart" style="min-height: 300px;"></div>
                                @else
                                    <div class="text-center text-muted py-5">ไม่มีข้อมูลการสั่งใช้ยาในช่วงเวลาดังกล่าว</div>
                                @endif
                            </div>
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                // Charts
                @if(count($chart_series_opd) > 0)
                var opdChart = new ApexCharts(document.querySelector("#herbalOpdChart"), {
                ...
                @if(count($chart_series_ipd) > 0)
                var ipdChart = new ApexCharts(document.querySelector("#herbalIpdChart"), {

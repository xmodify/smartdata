...
@section('content')
    <div class="container-fluid px-2 px-md-3">
        ...
        <ul class="nav nav-tabs nav-tabs-custom" id="hdReportTabs" role="tablist">
        ...
        <div class="tab-content" id="hdReportTabsContent">
            <!-- OPD Tab -->
                    ...
                    <div class="col-12">
                        <div class="card card-custom">
                            <div class="card-header bg-transparent border-0 pt-4 px-4">
                                <h6 class="fw-bold mb-0 text-green"><i class="fas fa-chart-line me-2"></i>มูลค่าการใช้ยา HD (Cost) รายเดือน แยกตามตัวยา (OPD)</h6>
                            </div>
                            <div class="card-body px-4 pb-4">
                                @if(count($chart_series_opd) > 0)
                                    <div id="hdOpdChart" style="min-height: 300px;"></div>
                                @else
                    ...
                    <div class="col-12 tab-pane-months-opd">
                        ...
                        <div class="tab-content" id="opdMonthsTabContent">
                            ...
                            <div class="tab-pane fade show active" id="opd-total-content" role="tabpanel">
                                <div class="card card-custom">
                                    <div class="card-header bg-transparent border-0 pt-4 px-4">
                                        <h6 class="fw-bold mb-0 text-green"><i class="fas fa-table me-2"></i>ตารางสถิติข้อมูลการใช้ยา HD (OPD) - ยอดรวมทั้งปี</h6>
                                    </div>
                                    <div class="card-body px-4 pb-4">
                            ...
                            @foreach($months_list as $month)
                                @php
                                    ...
                                    $monthly_data = isset($hd_opd_monthly[$month_key]) ? $hd_opd_monthly[$month_key] : [];
                                @endphp
                                <div class="tab-pane fade" id="opd-month-{{ $month_id }}-content" role="tabpanel">
                                    <div class="card card-custom">
                                        <div class="card-header bg-transparent border-0 pt-4 px-4">
                                            <h6 class="fw-bold mb-0 text-green"><i class="fas fa-table me-2"></i>ตารางสถิติข้อมูลการใช้ยา HD (OPD) - {{ $month['label'] }}</h6>
                                        </div>
                                        <div class="card-body px-4 pb-4">
                                            <div class="table-responsive">
            ...
            <div class="tab-pane fade" id="ipd-content" role="tabpanel">
                <div class="row g-4 mb-4">
                    ...
                    <div class="col-12">
                        <div class="card card-custom">
                            <div class="card-header bg-transparent border-0 pt-4 px-4">
                                <h6 class="fw-bold mb-0 text-red"><i class="fas fa-chart-line me-2"></i>มูลค่าการใช้ยา HD (Cost) รายเดือน แยกตามตัวยา (IPD)</h6>
                            </div>
                            <div class="card-body px-4 pb-4">
                                @if(count($chart_series_ipd) > 0)
                                    <div id="hdIpdChart" style="min-height: 300px;"></div>
                                @else
                                    <div class="text-center text-muted py-5">ไม่มีข้อมูลการสั่งใช้ยาในช่วงเวลาดังกล่าว</div>
                                @endif
                            </div>
                    ...
                    <div class="col-12 tab-pane-months-ipd">
                        ...
                        <div class="tab-content" id="ipdMonthsTabContent">
                            ...
                            <div class="tab-pane fade show active" id="ipd-total-content" role="tabpanel">
                                <div class="card card-custom">
                                    <div class="card-header bg-transparent border-0 pt-4 px-4">
                                        <h6 class="fw-bold mb-0 text-red"><i class="fas fa-table me-2"></i>ตารางสถิติข้อมูลการใช้ยา HD (IPD) - ยอดรวมทั้งปี</h6>
                                    </div>
                                    <div class="card-body px-4 pb-4">
                                        <div class="table-responsive">
                                            <table class="table table-hover align-middle table-pivot w-100" id="ipdTable">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        <th class="th-total">AN</th><th class="th-total">Qty</th><th class="th-total">ทุน (บาท)</th><th class="th-total">มูลค่า (บาท)</th>
                                                        <th class="th-ucs">AN</th><th class="th-ucs">Qty</th><th class="th-ucs">ทุน (บาท)</th><th class="th-ucs">มูลค่า (บาท)</th>
                                                        <th class="th-ofc">AN</th><th class="th-ofc">Qty</th><th class="th-ofc">ทุน (บาท)</th><th class="th-ofc">มูลค่า (บาท)</th>
                                                        <th class="th-lgo">AN</th><th class="th-lgo">Qty</th><th class="th-lgo">ทุน (บาท)</th><th class="th-lgo">มูลค่า (บาท)</th>
                                                        <th class="th-sss">AN</th><th class="th-sss">Qty</th><th class="th-sss">ทุน (บาท)</th><th class="th-sss">มูลค่า (บาท)</th>
                                                        <th class="th-other">AN</th><th class="th-other">Qty</th><th class="th-other">ทุน (บาท)</th><th class="th-other">มูลค่า (บาท)</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @foreach ($hd_ipd as $row)
                                                        <tr>
                                                            <td class="text-center font-monospace">{{ $row->icode }}</td>
                                                            <td class="fw-bold text-dark">{{ $row->drug_name }}</td>
                                                            <td>{{ $row->generic_name ?? '-' }}</td>
                            ...
                            @foreach($months_list as $month)
                                @php
                                    $month_key = $month['key'];
                                    $month_id = str_replace('-', '_', $month_key);
                                    $monthly_data = isset($hd_ipd_monthly[$month_key]) ? $hd_ipd_monthly[$month_key] : [];
                                @endphp
                                <div class="tab-pane fade" id="ipd-month-{{ $month_id }}-content" role="tabpanel">
                                    <div class="card card-custom">
                                        <div class="card-header bg-transparent border-0 pt-4 px-4">
                                            <h6 class="fw-bold mb-0 text-red"><i class="fas fa-table me-2"></i>ตารางสถิติข้อมูลการใช้ยา HD (IPD) - {{ $month['label'] }}</h6>
                                        </div>
                                        <div class="card-body px-4 pb-4">
                                            <div class="table-responsive">
    ...
    @push('scripts')
        ...
        <script>
            $(document).ready(function() {
                // Charts
                @if(count($chart_series_opd) > 0)
                var opdChart = new ApexCharts(document.querySelector("#hdOpdChart"), {
                ...
                @if(count($chart_series_ipd) > 0)
                var ipdChart = new ApexCharts(document.querySelector("#hdIpdChart"), {
                ...
                const getExportHeaderFormatter = function() {
                    return function(data, columnIdx) {
                        const prefixes = [
                            ...
                            "รวมทั้งหมด - ", "รวมทั้งหมด - ", "รวมทั้งหมด - ", "รวมทั้งหมด - ", // Visit, Qty, ทุน (บาท), มูลค่า (บาท)
                ...
                $('#opdTable').DataTable({
                    ...
                    buttons: [{
                        ...
                        title: 'รายงานสรุปการใช้ยา HD (OPD) - ยอดรวมทั้งปี',
                        exportOptions: {
                            columns: ':visible',
                ...
                @foreach($months_list as $month)
                    ...
                    $('#table-opd-{{ $month_id }}').DataTable({
                        ...
                        buttons: [{
                            ...
                            text: '<i class="fas fa-file-excel me-1"></i> Excel',
                            className: 'btn btn-success btn-sm',
                            title: 'รายงานสรุปการใช้ยา HD (OPD) - {{ $month['label'] }}',
                            exportOptions: {
                                columns: ':visible',
                                format: { header: getExportHeaderFormatter() }
                            }
                ...
                $('#ipdTable').DataTable({
                    ...
                    buttons: [{
                        ...
                        text: '<i class="fas fa-file-excel me-1"></i> Excel',
                        className: 'btn btn-success btn-sm',
                        title: 'รายงานสรุปการใช้ยา HD (IPD) - ยอดรวมทั้งปี',
                        exportOptions: {
                            columns: ':visible',
                            format: { header: getExportHeaderFormatter() }
                        }
                ...
                @foreach($months_list as $month)
                    ...
                    $('#table-ipd-{{ $month_id }}').DataTable({
                        ...
                        buttons: [{
                            ...
                            text: '<i class="fas fa-file-excel me-1"></i> Excel',
                            className: 'btn btn-success btn-sm',
                            title: 'รายงานสรุปการใช้ยา HD (IPD) - {{ $month['label'] }}',
                            exportOptions: {
                                columns: ':visible',
                                format: { header: getExportHeaderFormatter() }
                            }

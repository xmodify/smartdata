                    ...
                    <div class="col-12 tab-pane-months-opd">
                        ...
                        <div class="tab-content" id="opdMonthsTabContent">
                            ...
                            <div class="tab-pane fade show active" id="opd-total-content" role="tabpanel">
                                <div class="card card-custom">
                                    <div class="card-header bg-transparent border-0 pt-4 px-4">
                                        <h6 class="fw-bold mb-0 text-green"><i class="fas fa-table me-2"></i>ตารางสถิติข้อมูลการใช้ยา ESRD (OPD) - ยอดรวมทั้งปี</h6>
                                    </div>
                                    <div class="card-body px-4 pb-4">
                            ...
                            @foreach($months_list as $month)
                                @php
                                    ...
                                    $monthly_data = isset($esrd_opd_monthly[$month_key]) ? $esrd_opd_monthly[$month_key] : [];
                                @endphp
                                <div class="tab-pane fade" id="opd-month-{{ $month_id }}-content" role="tabpanel">
                                    <div class="card card-custom">
                                        <div class="card-header bg-transparent border-0 pt-4 px-4">
                                            <h6 class="fw-bold mb-0 text-green"><i class="fas fa-table me-2"></i>ตารางสถิติข้อมูลการใช้ยา ESRD (OPD) - {{ $month['label'] }}</h6>
                                        </div>
                                        <div class="card-body px-4 pb-4">
                                            <div class="table-responsive">
                    ...
                    <div class="col-12 tab-pane-months-ipd">
                        ...
                        <div class="tab-content" id="ipdMonthsTabContent">
                            ...
                            <div class="tab-pane fade show active" id="ipd-total-content" role="tabpanel">
                                <div class="card card-custom">
                                    <div class="card-header bg-transparent border-0 pt-4 px-4">
                                        <h6 class="fw-bold mb-0 text-red"><i class="fas fa-table me-2"></i>ตารางสถิติข้อมูลการใช้ยา ESRD (IPD) - ยอดรวมทั้งปี</h6>
                                    </div>
                                    <div class="card-body px-4 pb-4">
                                        <div class="table-responsive">
                            ...
                            @foreach($months_list as $month)
                                @php
                                    $month_key = $month['key'];
                                    $month_id = str_replace('-', '_', $month_key);
                                    $monthly_data = isset($esrd_ipd_monthly[$month_key]) ? $esrd_ipd_monthly[$month_key] : [];
                                @endphp
                                <div class="tab-pane fade" id="ipd-month-{{ $month_id }}-content" role="tabpanel">
                                    <div class="card card-custom">
                                        <div class="card-header bg-transparent border-0 pt-4 px-4">
                                            <h6 class="fw-bold mb-0 text-red"><i class="fas fa-table me-2"></i>ตารางสถิติข้อมูลการใช้ยา ESRD (IPD) - {{ $month['label'] }}</h6>
                                        </div>
                                        <div class="card-body px-4 pb-4">
                                            <div class="table-responsive">
            ...
            $(document).ready(function() {
                ...
                $('#opdTable').DataTable({
                    ...
                    buttons: [{
                        ...
                        title: 'รายงานสรุปการใช้ยา ESRD (OPD) - ยอดรวมทั้งปี',
                        exportOptions: {
                            columns: ':visible',
                ...
                @foreach($months_list as $month)
                    ...
                    $('#table-opd-{{ $month_id }}').DataTable({
                        ...
                        buttons: [{
                            ...
                            text: '<i class="fas fa-file-excel me-1"></i> Excel',
                            className: 'btn btn-success btn-sm',
                            title: 'รายงานสรุปการใช้ยา ESRD (OPD) - {{ $month['label'] }}',
                            exportOptions: {
                                columns: ':visible',
                                format: { header: getExportHeaderFormatter() }
                            }
                ...
                $('#ipdTable').DataTable({
                    ...
                    buttons: [{
                        ...
                        text: '<i class="fas fa-file-excel me-1"></i> Excel',
                        className: 'btn btn-success btn-sm',
                        title: 'รายงานสรุปการใช้ยา ESRD (IPD) - ยอดรวมทั้งปี',
                        exportOptions: {
                            columns: ':visible',
                            format: { header: getExportHeaderFormatter() }
                        }
                ...
                @foreach($months_list as $month)
                    ...
                    $('#table-ipd-{{ $month_id }}').DataTable({
                        ...
                        buttons: [{
                            ...
                            text: '<i class="fas fa-file-excel me-1"></i> Excel',
                            className: 'btn btn-success btn-sm',
                            title: 'รายงานสรุปการใช้ยา ESRD (IPD) - {{ $month['label'] }}',
                            exportOptions: {
                                columns: ':visible',
                                format: { header: getExportHeaderFormatter() }
                            }

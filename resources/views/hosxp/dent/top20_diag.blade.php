    ...
    <div class="container-fluid px-2 px-md-3">
        <div class="page-header-container d-flex justify-content-between align-items-center mt-3">
            ...
            <div class="d-flex align-items-center">
                <form action="" method="GET" id="filter-form" class="m-0 header-form-controls d-flex align-items-center gap-2">
                    ...
                    <div class="input-group input-group-sm shadow-sm" style="width: 160px; border-radius: 8px; overflow: hidden;">
                    ...
                    <div class="input-group input-group-sm shadow-sm" style="width: 250px; border-radius: 8px; overflow: hidden;">
        ...
        <div class="row g-4 mb-4">
            <div class="col-xl-6">
                <div class="card border-0 shadow-sm h-100" style="border-radius: 15px;">
                    <div class="card-header bg-white py-3 border-0">
                        <h6 class="fw-bold mb-0 text-purple"><i class="fas fa-chart-bar me-2"></i>กราฟแสดง 20 อันดับโรค</h6>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-xl-6">
                <div class="card border-0 shadow-sm h-100" style="border-radius: 15px;">
                    <div class="card-header bg-white py-3 border-0">
                        <h6 class="fw-bold mb-0 text-purple"><i class="fas fa-table me-2"></i>ตารางข้อมูล 20 อันดับโรค</h6>
                    </div>
                                    ...
                                    @foreach ($diag_top20 as $index => $row)
                                        <tr>
                                            <td class="text-center">
                                                ...
                                                @elseif($index === 2)
                                                    <span class="badge rounded-pill text-dark py-1 px-2" style="background: linear-gradient(135deg, #fed7aa 0%, #a855f7 100%) !important;">
                                            ...
                                            <td class="text-center fw-bold text-purple">{{ number_format($row->sum) }}</td>
        ...
        <script>
            $(document).ready(function() {
                    ...
                    new Chart(document.getElementById('chartDiag'), {
                        ...
                        options: {
                            ...
                            plugins: {
                                ...
                                datalabels: { anchor: 'end', align: 'right', color: '#9333ea', font: { weight: 'bold', size: 10 }, formatter: Math.round }
                            },
                            scales: { x: { display: false, beginAtZero: true }, y: { ticks: { font: { size: 10 } } } },
                ...
                $('#tableDiag').DataTable({
                    ...
                    buttons: [{ extend: 'excelHtml5', text: '<i class="fa-solid fa-file-excel me-1"></i> Excel', className: 'btn btn-success', title: '{{ $title }}' }],

...
<div class="container-fluid px-2 px-md-3">
    <div class="page-header-container d-flex justify-content-between align-items-center mt-3">
        <div class="d-flex align-items-center report-title-box">
            <div class="ps-3 py-1">
                <h5 class="text-dark mb-0 fw-bold"><i class="fas fa-home text-yellow me-2"></i> {{ $title }}</h5>
        ...
        <div class="d-flex align-items-center">
            <form action="" method="GET" class="m-0 header-form-controls">
                <div class="input-group input-group-sm shadow-sm input-group-date" style="border-radius: 8px; overflow: hidden;">
                    <span class="input-group-text bg-white border-end-0 text-yellow"><i class="fas fa-calendar-alt"></i></span>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm" style="border-radius: 15px;">
                <div class="card-body p-5 text-center">
                    <div class="mb-4"><i class="fas fa-home fa-4x text-muted opacity-25"></i></div>
                    <h4 class="fw-bold">อยู่ระหว่างการพัฒนา</h4>
                    <p class="text-muted">ระบบรายงานงานเชิงรุก PCU กำลังอยู่ในขั้นตอนการจัดสรรข้อมูลและออกแบบรายงานเพื่อเพิ่มประสิทธิภาพในการวิเคราะห์</p>

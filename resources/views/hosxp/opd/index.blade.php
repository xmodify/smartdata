        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm" style="border-radius: 15px;">
                <div class="card-body p-5 text-center">
                    <div class="mb-4">
                        <i class="fas fa-microscope fa-4x text-muted opacity-25"></i>
                    </div>
                    <h4 class="fw-bold">อยู่ระหว่างการพัฒนา</h4>
                    <p class="text-muted">ระบบรายงานงานบริการผู้ป่วยนอก (OPD) กำลังอยู่ในขั้นตอนการจัดสรรข้อมูลและออกแบบรายงานเพื่อเพิ่มประสิทธิภาพในการวิเคราะห์</p>
                    <div class="mt-4">
                        <a href="{{ route('hosxp.stats.top20_opd') }}" class="btn btn-primary me-2">
                            <i class="fas fa-chart-line me-1"></i> ดูรายงาน 20 อันดับโรค OPD
                        </a>

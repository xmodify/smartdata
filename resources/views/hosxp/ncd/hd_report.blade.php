        ...
        <div class="page-header-container d-flex flex-wrap justify-content-between align-items-center mt-3">
            <div class="d-flex align-items-center report-title-box">
                <div class="ps-3 py-1">
                    ...
                    <div class="text-muted small mt-1">สรุปผลการดำเนินงานการให้บริการผู้ป่วยคลินิกฟอกไต HD ปีงบประมาณ
            ...
            <div class="col-lg-6">
                <div class="card border-0 shadow-sm" style="border-radius: 20px;">
                    <div class="card-header bg-transparent border-0 pt-4 px-4">
                        <h5 class="fw-bold mb-0">กราฟจำนวนผู้รับบริการฟอกไตรายเดือน</h5>
            ...
            <div class="col-12">
                <div class="card border-0 shadow-sm" style="border-radius: 20px;">
                    <div class="card-header bg-pastel-teal py-3 border-0 d-flex justify-content-between align-items-center" style="border-radius: 20px 20px 0 0;">
                        <h6 class="fw-bold mb-0 text-teal"><i class="fas fa-table me-2"></i>ตารางสถิติแยกตามกลุ่มสิทธิการรักษาและค่าใช้จ่าย</h6>
                ...
                $('.btn-export-excel').on('click', function() {
                    ...
                    const dt = $(target).DataTable({
                        ...
                        buttons: [{
                            extend: 'excelHtml5',
                            title: title,
                            messageTop: 'ข้อมูลการให้บริการฟอกไต HD ระหว่างวันที่ {{ DateThai($start_date) }} ถึง {{ DateThai($end_date) }}',

...
class VectorRagService
{
    ...
    public function searchAndAnswer(string $question, ?int $specificDocId = null): array
    {
        ...
        $systemPrompt = "คุณคือ SmartData Copilot ผู้ช่วยตอบคำถามจากคลังความรู้โรงพยาบาล
หน้าที่ของคุณคือ: ตอบคำถามของผู้ใช้โดยอ้างอิงข้อมูลจากบริบทเอกสารที่จัดเตรียมให้เท่านั้น
กฎเกณฑ์การตอบ:

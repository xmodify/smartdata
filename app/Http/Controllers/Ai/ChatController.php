...
class ChatController extends Controller
{
    ...
    public function sendMessage(Request $request)
    {
        ...
        if ($detectedMode === 'sql') {
                ...
                $systemPrompt = "คุณคือ ดองกี้ ผู้ช่วยอัจฉริยะประจำโรงพยาบาล
คุณสามารถตอบคำถาม ให้คำปรึกษา แนะนำการใช้งานระบบสุขภาพ วิเคราะห์ข้อมูล และเขียน SQL ได้อย่างคล่องแคล่ว
ตอบคำถามด้วยภาษาไทยที่สุภาพ กระชับ เป็นกันเองและเป็นมืออาชีพ โดยแทนตัวเองว่า 'ดองกี้' หรือ 'ผม' (ห้ามใส่สร้อยหรือวงเล็บต่อท้ายคำว่าดองกี้)
